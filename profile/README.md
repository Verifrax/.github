...
- Implementation, host, support, and package surfaces do not outrank law, accepted epoch, authority objects, execution receipts, verification results, recognition objects, or recourse objects.

## Public hosts

- `www.verifrax.net` — public root and commercial entry surface
- `api.verifrax.net` — API and machine-access boundary
...
- `status.verifrax.net` — operational status surface
...
### Implementation, host, support, and package strata
...
This is the public package order.
